...
async function createCLIConfigFile() {
  try {
    ...
    console.log(
      chalk.cyan(
        "It looks like this is the first time that you're running datart-cli-config within this project.",
      ),
    );
    console.log();
    console.log(
      chalk.cyan(
        'Answer a few questions to customize datart-cli-config for your project needs (this will create a "datart-cli-config.json" config file on the root level of this project).',
      ),
    );
    console.log(
      chalk.cyan(
    ...
    console.error(
      chalk.red.bold(
        'ERROR: Could not create a "datart-cli-config.json" config file.',
      ),
    );
    return e;
  }
...
async function updateCLIConfigFile(missingConfigQuestions, currentConfigFile) {
  try {
    ...
    console.log(
      chalk.cyan(
        'Please answer a few questions to update the "datart-cli-config.json" config file.',
      ),
    );
    console.log(
      chalk.cyan(
    ...
    console.log(
      chalk.cyan(
        'The ("datart-cli-config.json") has successfully updated for this project.',
      ),
    );
    ...
    console.error(
      chalk.red.bold(
        'ERROR: Could not update the "datart-cli-config.json" config file.',
      ),
    );
    return e;
  }
...
async function getCLIConfigFile() {
  ...
  try {
    ...
    console.error(
      chalk.red.bold(
        "ERROR: Please make sure that you're running the datart-cli-config commands from the root level of your React project",
      ),
    );
